...
urlpatterns = patterns('',
    ...
    url(r'^file/(?P<id>.+)/note/add/$', files.NoteAdd.as_view(), name='podaci_files_note_add'),
    url(r'^file/(?P<id>.+)/note/delete/$', files.NoteDelete.as_view(), name='podaci_files_note_add'),
    url(r'^file/(?P<id>.+)/note/update/$', files.NoteUpdate.as_view(), name='podaci_files_note_add'),
