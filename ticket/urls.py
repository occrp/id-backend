...
urlpatterns = [
    ...
    url(r'^all_closed/(?P<page>\d+)/$', perm('staff', ticket.views.TicketListAllClosed), name='ticket_all_closed_list'),
    ...
    url(r'^assigned/$', perm('staff', ticket.views.TicketListMyAssigned), name='ticket_assigned_list'),
    url(r'^assigned/(?P<page>\d+)/$', perm('staff', ticket.views.TicketListMyAssigned), name='ticket_assigned_list'),
    url(r'^assigned/closed/$', perm('staff', ticket.views.TicketListMyAssignedClosed), name='ticket_assigned_closed_list'),
    url(r'^assigned/closed/(?P<page>\d+)/$', perm('staff', ticket.views.TicketListMyAssignedClosed), name='ticket_assigned_closed_list'),
    ...
    url(r'^public/closed/(?P<page>\d+)/$', perm('user', ticket.views.TicketListPublicClosed), name='ticket_public_closed_list'),
    url(r'^unassigned/$', perm('user', ticket.views.TicketListUnassigned), name='ticket_unassigned_list'),
    url(r'^unassigned/(?P<page>\d+)/$', perm('user', ticket.views.TicketListUnassigned), name='ticket_unassigned_list'),
    url(r'^upcoming_deadline/$', perm('user', ticket.views.TicketListUpcomingDeadline), name='ticket_deadline_list'),
    url(r'^upcoming_deadline/(?P<page>\d+)/$', perm('user', ticket.views.TicketListUpcomingDeadline), name='ticket_deadline_list'),
    url(r'^user/(?P<user_id>\d+)/$', perm('staff', ticket.views.TicketListUser), name='ticket_user_list'),
    url(r'^user/(?P<user_id>\d+)/(?P<page>\d+)/$', perm('staff', ticket.views.TicketListUser), name='ticket_country_list'),
    ...
    url(r'^country/(?P<country>.+)/(?P<page>\d+)/$', perm('staff', ticket.views.TicketListCountry), name='ticket_country_list'),

    url(r'^submit/$', perm('user', ticket.views.TicketRequest), name='ticket_submit'),
    url(r'^manage/(?P<ticket_id>[0-9]+)/details/$', perm('user', ticket.views.TicketDetail), name='ticket_details'),
    ...
    url(r'^manage/(?P<ticket_id>[0-9]+)/edit/$', perm('user', ticket.views.TicketRequest), name='ticket_edit'),
    url(r'^manage/company_ownership/(?P<pk>[0-9]+)/edit/$', perm('user', ticket.views.CompanyTicketUpdate), name='company_ownership_ticket_edit'),
    url(r'^manage/person_ownership/(?P<pk>[0-9]+)/edit/$', perm('user', ticket.views.PersonTicketUpdate), name='person_ownership_ticket_edit'),
    url(r'^manage/other/(?P<pk>[0-9]+)/edit/$', perm('user', ticket.views.OtherTicketUpdate), name='other_ticket_edit'),
    ...
    url(r'^(?P<pk>[0-9]+)/join/$', perm('staff', ticket.views.TicketActionJoin), name='ticket_join'),
    url(r'^(?P<pk>[0-9]+)/leave/$', perm('staff', ticket.views.TicketActionLeave), name='ticket_leave'),
    ...
    url(r'^(?P<pk>[0-9]+)/updateremove/$', perm('staff', ticket.views.TicketUpdateRemoveHandler), name='ticket_update_remove'),
